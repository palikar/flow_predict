...
The viscosity-density and inflow speed models are evaluated with several simulations with different parameters. As it is impractical to give the results of the evaluation of each simulation, here we present only several of them. The showed results, however, are representative of the general performance of our models. For this section, we also limit ourselves only to models that do use the pressure field of the simulations.
...
\begin{table}
  \begin{center}
    \begin{tabular}{l|cc|cc}
      \textbf{Frame} & \multicolumn{2}{c|} {\shortstack{\textbf{Simulation 8}\\$\nu=4.17647, \rho = 0.001, g=1.4$}}  &  \multicolumn{2}{c}{\shortstack{\textbf{Simulation 39}\\$\nu=4.17647, \rho = 0.001, g=1.4$}}\\
      \hline 
                     &\multicolumn{2}{c|}{} & &\\
    ...
    \end{tabular}
  \end{center}
  \caption{Your caption.}\label{tab:recursive_inflow}
\end{table}
